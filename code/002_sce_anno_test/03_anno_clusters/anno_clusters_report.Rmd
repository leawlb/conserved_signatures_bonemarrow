...
gene_list <- read.csv(snakemake@input[["gene_list_all"]], 
  header = TRUE, 
  sep = ";", 
  check.names=FALSE, 
...
gene_markers_all <- unique(gene_list_temp[,1])
print(gene_markers_all)

all_markers <- unique(c(found_markers, gene_markers_all))
