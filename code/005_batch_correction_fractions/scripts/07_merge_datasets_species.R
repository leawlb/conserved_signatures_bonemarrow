...
sce_06_path <- snakemake@input[["sce_06_path"]] # correct cell annotation output
sce_07_hsc_path <- snakemake@output[["sce_07_hsc_path"]] # correct merging output
sce_07_str_path <- snakemake@output[["sce_07_str_path"]] # correct merging output
