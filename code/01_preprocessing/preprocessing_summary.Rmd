...
# by Sample
ggplot(qcdf_gg, aes(x = Object_ID, y = sum, color = Discard))+
...
ggplot(qcdf_gg, aes(x = Object_ID, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
...
# by Species_ID
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Species_ID, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Species_ID, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
# by Age
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Age, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Age, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
# by Fraction
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Fraction, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Fraction, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
# by Batch_exp_day
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Batch_exp_day, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Batch_exp_day, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
# by Batch_sequencing
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Batch_sequencing, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Batch_sequencing, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
# by Date_collected
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Date_collected, y = sum, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 80000))+
...
ggplot(qcdf_gg[qcdf_gg$Discard == FALSE,], aes(x = Date_collected, y = detected, color = Discard))+
  ggbeeswarm::geom_quasirandom(alpha = 0.5, size = 0.1)+
  theme_classic()+
  theme(axis.text = element_text(angle = 90))+
  ylim(limits = c(0, 40000))+
...
plot_list_all <- make_plots(merged_list[[1]], title = "all merged (including discarded)")
...
sce_04_path <- "/omics/groups/OE0538/internal/users/l012t/Interspecies_BM_phd/data/02_preprocessing/norm"
