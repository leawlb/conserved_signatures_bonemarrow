...
sce_01 <- readRDS(file = snakemake@input[["sce_input"]])
sce_02 <- readRDS(file = snakemake@input[["sce_01"]])
sce_03 <- readRDS(file = snakemake@input[["sce_02"]])
sce_04 <- readRDS(file = snakemake@input[["sce_03"]])
sce_05 <- readRDS(file = snakemake@input[["sce_04"]])
...
qcdf_02 <- perCellQCMetrics(sce_02, subsets=list(Mito=mito_genes)) 
