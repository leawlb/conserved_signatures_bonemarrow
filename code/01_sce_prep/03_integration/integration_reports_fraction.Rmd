---
title: "Report on fraction integration"
author: "Lea Wölbert"
date: '2023-06-14'
...
make_plots <- function(sce, title){
  ...
  col_cts_baccin_clst <- col_cts_ref[
    match(unique(sce$baccin_celltype_scmapclust), names(col_cts_ref))]
  col_cts_dahlin_clst <- col_cts_ref[
    match(unique(sce$dahlin_celltype_scmapclust), names(col_cts_ref))]
  col_cts_dolgalev_clst <- col_cts_ref[
    match(unique(sce$dolgalev_celltype_scmapclust), names(col_cts_ref))]
