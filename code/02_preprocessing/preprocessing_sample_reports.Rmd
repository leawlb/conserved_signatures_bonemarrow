...
# set name for plots
name_curr <- colData(sce_02)$Object_ID[1] # choose name to display in plots
...
plot_4 <- umap_base(sce_05, color_by = "sum")+
  scale_color_gradientn("Library size", 
                         ...
                         colors = c("black", "darkorange4", "darkorange3", "darkorange1",
                                    ...
                                    "lightgoldenrod", "lightgoldenrod", 
                                    "lightgoldenrod", "lightgoldenrod"))
plot_4l <- umap_legend(sce_05, color_by = "sum")+
  scale_color_gradientn("Library size", 
                         limits = c(0, 1000000),
                          colors = c("black", "darkorange4", "darkorange3", "darkorange1",
                                    "orange", "orange", "gold1", "gold",
