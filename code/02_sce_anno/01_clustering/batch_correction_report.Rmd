...
make_big_grid <- function(sce, title){
  ...
  sce_1 <- sce[,sce$Object_ID %in% 
                 unique(sce$Object_ID)[1:as.integer(n_objects/5)]]
  sce_2 <- sce[,sce$Object_ID %in%
                 unique(sce$Object_ID)[(as.integer(n_objects/5)+1):
                                         (as.integer(n_objects/5)*2)]]
  sce_3 <- sce[,sce$Object_ID %in% 
                 unique(sce$Object_ID)[(as.integer(n_objects/5)*2+1):
                                         (as.integer(n_objects/5)*3)]]
  sce_4 <- sce[,sce$Object_ID %in% 
                 unique(sce$Object_ID)[(as.integer(n_objects/5)*3+1):
                                         (as.integer(n_objects/5)*4)]]
  sce_5 <- sce[,sce$Object_ID %in%
                 unique(sce$Object_ID)[(as.integer(n_objects/5)*4+1):
                                         n_objects]]
...
```{r big_grids, fig.width=10, fig.height=4}
#biggrid_plotlist
```
...
```{r qcumaps, fig.width=10, fig.height=5}
#qc_umap_plotlist
```
