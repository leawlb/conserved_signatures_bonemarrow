...
#sce_input_raw <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/scRNAseq/main_analysis/sce_objects/01_sce_prep/08_mrge/fractions/sce_str-08")
#sce_mnn <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/scRNAseq/main_analysis/sce_objects/02_sce_anno/01_mnnc/sce_str_Object_ID-01")
...
sce_input_raw_test1 <- sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mspr_old_str_5_0", "mspr_old_str_4_0")]
sce_input_raw_test2 <- sce_input_raw[,sce_input_raw$Species_ID == "mspr"]

sce <- sce_input_raw_test1
...
plotPCA(sce, color_by = "Object_ID")
plotPCA(sce, color_by = "Age_ID")


sce <- sce_input_raw_test2
...
umap_base_l(sce_input_raw[,sce_input_raw$Species_ID == "mspr"], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID == "mspr_yng_str_1_0"], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID == "mspr_yng_str_3_2"], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mspr_old_str_5_0", "mspr_old_str_4_0")], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mspr_old_str_5_0", "mspr_old_str_4_0")], color_by = "Age_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mspr_yng_str_3_2")], color_by = "Object_ID")

umap_base_l(sce_input_raw[,sce_input_raw$Species_ID %in% c("mspr", "mcar")], color_by = "Object_ID")

umap_base_l(sce_input_raw[,sce_input_raw$Species_ID == "mspr"], color_by = "Age_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Species_ID == "mspr"], color_by = "Antibody_combination")

umap_base_l(sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mcar_old_str_5_0", "mcar_old_str_4_0", "mcar_yng_str_1_0")], color_by = "Object_ID")

umap_base_l(sce_input_raw[,sce_input_raw$Object_ID == "mspr_yng_str_1_0"], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID == "mspr_old_str_5_0"], color_by = "Object_ID")
umap_base_l(sce_input_raw[,sce_input_raw$Object_ID == "mspr_old_str_4_0"], color_by = "Object_ID")

sce_input_raw_test <- sce_input_raw[,sce_input_raw$Object_ID %in% c("mspr_yng_str_1_0", "mspr_old_str_5_0", "mspr_old_str_4_0")]

sce <- sce_input_raw_test
library(scater)
library(scran) 
