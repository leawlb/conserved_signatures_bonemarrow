...
col_cts_baccin <- col_cts_ref[match(levels(sce_l$baccin_celltype_scmapclust), 
                                names(col_cts_ref))]
col_cts_dahlin <- col_cts_ref[match(levels(sce_l$dahlin_celltype_scmapclust), 
                                names(col_cts_ref))]
col_cts_dolgalev <- col_cts_ref[match(levels(sce_l$dolgalev_celltype_scmapclust),
                                  names(col_cts_ref))]
...
plot3a <- ggplot(ggdf, aes(x = cluster_louvain,
  ...
  geom_bar(position = "stack") + 
  theme_classic()+
  scale_fill_manual(name = "Age", values = col_age)+
  scale_color_manual(name = "Age", values = col_age)+
  theme(axis.text.x = element_text(angle = 90))+
  ggtitle(paste0(fraction_curr, sce_l$k_louvain[1]))
...
plot5a <- ggplot(ggdf, aes(x = cluster_louvain, 
  ...
  geom_bar(position = "stack") + 
  theme_classic()+
  scale_fill_manual(name = "Age", values = col_spc)+
  scale_color_manual(name = "Age", values = col_spc)+
  theme(axis.text.x = element_text(angle = 90))+
  ggtitle(paste0(fraction_curr, sce_l$k_louvain[1]))+
