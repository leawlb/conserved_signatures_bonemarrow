...
gene_list_dtplt_main <- gene_list_dtplt[
  gene_list_dtplt$use == "main",] 
gene_list_dtplt_ECs <- gene_list_dtplt[
  gene_list_dtplt$use == "ECs",] 
gene_list_dtplt_short <- gene_list_dtplt[
  gene_list_dtplt$use == "short",] 
```
...
all_genes <- base::unique(gene_list_dtplt$gene)
...
# only needs to be calculated for str (for now)
...
```{r subset_ec_genes}
c_arteries <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "A"])
c_capillary <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "C"])
c_venous <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "V"])
c_sinus <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "S"])
c_lymph <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "L"])
c_others <- base::sort(
  gene_list_dtplt_ECs$gene[gene_list_dtplt_ECs$marker_for == "?"])
```

```{r str_ggdotplot_ECs, fig.width = 15, fig.height = 3.3}
...
```{r str_ggdotplot_cap, fig.width = 7, fig.height = 3.3}
if(fraction_curr == "str"){
...
```{r str_ggdotplot_ven, fig.width = 7, fig.height = 3.3}
if(fraction_curr == "str"){
...
```{r str_ggdotplot_sin, fig.width = 6, fig.height = 3.3}
if(fraction_curr == "str"){
...
```{r str_ggdotplot_lym, fig.width = 5, fig.height = 3.3}
if(fraction_curr == "str"){
...
```{r str_ggdotplot_others, fig.width = 8, fig.height = 3.3}
if(fraction_curr == "str"){
  vis_df_ECs_oth <- vis_df_ECs[vis_df_ECs$gene %in% c_others,]
  standard_dotplot(vis_df_ECs_oth)
}
```
...
if(fraction_curr == "str"){
  ...
  gene_list_dtplt_use <- gene_list_dtplt_short
...
vis_df_allall_long_hsc <- vis_df_allall_long[vis_df_allall_long$celltype == "HSCs",]
vis_df_allall_long_hsc[order(vis_df_allall_long_hsc$expression, decreasing = TRUE),]
...
vis_df_allall_long <- vis_df_allall_long[order(vis_df_allall_long$is_true, decreasing = TRUE),]
