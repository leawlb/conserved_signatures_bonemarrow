...
for(s in species_all){
  sce_list_06[[s]] <- readRDS(file = paste0(sce_06_path, "/sce_", s, "-06"))
}
print(sce_list_06)
...
for(b in batches){
  for(s in species_all){
    sce_list_07[[b]][[s]] <- readRDS(file = paste0(sce_07_path, "/sce_", s, "_", b, "-07"))
  }
}  
print(sce_list_07)
...
for(b in batches){
  for(s in species_all){
    sce_list_08mnn[[b]][[s]] <- readRDS(file = paste0(sce_08mnn_path, "/sce_", s, "_", b, "-08"))
  }
}  
...
plot_list_06 <- make_plots(sce_list_06)
plot_list_07_1 <- make_plots(sce_list_07[[batches[1]]])
plot_list_08mnn_1 <- make_plots(sce_list_08mnn[[batches[1]]])
