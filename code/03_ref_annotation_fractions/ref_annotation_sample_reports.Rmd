...
col_cts_baccin_cell <- col_cts[match(levels(sce$baccin_celltype_scmapcell), names(col_cts))]
col_cts_baccin_clst <- col_cts[match(levels(sce$baccin_celltype_scmapclust), names(col_cts))]
col_cts_dahlin_cell <- col_cts[match(levels(sce$dahlin_celltype_scmapcell), names(col_cts))]
col_cts_dahlin_clst <- col_cts[match(levels(sce$dahlin_celltype_scmapclust), names(col_cts))]
col_cts_dolgalev_cell <- col_cts[match(levels(sce$dolgalev_celltype_scmapcell), names(col_cts))]
col_cts_dolgalev_clst <- col_cts[match(levels(sce$dolgalev_celltype_scmapclust), names(col_cts))]
