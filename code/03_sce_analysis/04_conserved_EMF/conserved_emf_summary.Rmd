...
#emf_list_str <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/scRNAseq/main_analysis/sce_objects/03_sce_analysis/04_conserved_EMF/01_emfs/emf_list_str")
#emf_list_hsc <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/scRNAseq/main_analysis/sce_objects/03_sce_analysis/04_conserved_EMF/01_emfs/emf_list_hsc")
emf_list_str <- readRDS(snakemake@input[["emf_list_str"]])
fraction_curr <- snakemake@wildcards[["fraction"]]
#emf_list_hsc$HSCs$marker_cons_ct[emf_list_hsc$HSCs$marker_cons_ct$gene == "Egr1",]
```
...
```{r}
emf_list_hsc$HSCs$marker_cons_ct
hsc_list <- emf_list_hsc$HSCs$cons_emf
...
```{r}
adipo_list <- emf_list_str$`Adipo/CARs`$df_core$gene[order(emf_list_str$`Adipo/CARs`$df_core$mmus, decreasing = TRUE)]
