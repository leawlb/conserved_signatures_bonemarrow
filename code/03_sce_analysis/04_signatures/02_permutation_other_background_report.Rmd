...
scores <- base::unique(score_df$type)[1:6]
...
score_df_temp <- score_df[!score_df$type %in% c(
  "nr_celltypes",
  "nr_clusters",
...
score_df_temp <- score_df_temp[score_df_temp$conservation_level == cons_level_use,]
...
ggplot(score_df_temp, aes(x = type, y = value))+
  ...
  geom_point(color = col_show, size = 3, alpha = 0.7, position = position_nudge(x = -0.2, y = 0))+
