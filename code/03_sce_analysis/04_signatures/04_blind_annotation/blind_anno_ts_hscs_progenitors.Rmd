...
seu_sign_o2$annotated_reclustered[
  seu_sign_o2$seurat_clusters == nr] <- "Early Granu/Mono prog"
```
...
seu_sign_o2$annotated_reclustered[
  seu_sign_o2$seurat_clusters == nr] <- "Granu prog"
```
...
seu_sign_o2$annotated_reclustered[
  seu_sign_o2$seurat_clusters == nr] <- "Early Myeloid prog"
```
...
seu_sign_o2$annotated_reclustered[
  seu_sign_o2$seurat_clusters == nr] <- "Mono/Dendritic prog"
```
...
seu_sign_o2$annotated_reclustered[
  seu_sign_o2$seurat_clusters == nr] <- "Lymphoid prog"
```
...
Seurat::DimPlot(seu_sign_o2, reduction = "umap", group.by = "annotated_reclustered")
```
