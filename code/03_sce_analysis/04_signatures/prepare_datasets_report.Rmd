...
ts_bone_marrow <- snakemake@input[["ts_bone_marrow"]] # human HSPC 
ts_hscs_progenitors <- snakemake@input[["ts_hscs_progenitors"]] # human HSPC 

mus_weinreb_hspc <- snakemake@input[["mus_weinreb_hspc"]] # mouse HSPC 
mus_tm_bonemarrow <- snakemake@input[["mus_tm_bonemarrow"]] # mouse HSPC 

#zeb_all_hspc <- snakemake@input[["zeb_all_hspc"]] # zebrafish HSPC 
#nmr_sorted_hspc <- snakemake@input[["nmr_sorted_hspc"]] # naked mole rat HSPC 
...
```{r zeb_all_hspc, eval = FALSE, include = FALSE}
zeb_all_hspc
zeb_all_hspc@assays
...
```{r nmr_sorted_hspc, eval = FALSE, include = FALSE}
nmr_sorted_hspc
