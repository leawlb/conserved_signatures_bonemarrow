...
col_vec1 <- c("proportion_of_zeros" = "goldenrod1",
...
vis_perc_wide_gg <- function(seu, correction_vec = NULL, title_add= NULL){
  ...
  # for nicer look, choose manually (downstream)
...
vis_nr_cl_nr_cell <- function(seu_list, title){
  ...
  title <- base::paste(vis_df_all$conservation_level[1], title)
  ...
  plot1 <- ggplot2::ggplot(vis_df_all, 
    ...
    ggplot2::geom_hline(yintercept = vis_df_all$nr_celltypes[1], 
                        ...
                        linetype = "dashed")+
    ggplot2::theme_classic()+
    ggplot2::ylim(c(0, max(vis_df_all$nr_celltypes[1], 
                           vis_df_all$value)))+
