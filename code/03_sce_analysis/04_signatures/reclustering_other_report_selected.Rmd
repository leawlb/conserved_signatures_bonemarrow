...
if(dataset_curr == "zeb_all_hspc"){
  ...
  correction_vec_list <- list(
    "conserved_signature" = c(2, 4, 6, 9, 13, 14, 9, 10, 16, 18, 20, 3, 5, 1, 7, 8, 5, 17, 15, 12, 19, 11, 22, 21, 23, 25, 26, 27, 24),
    "conserved_markers" = c(4, 5, 16, 17, 18, 19, 20, 22, 24, 15, 1, 9, 7, 3, 6, 13, 28, 8, 10, 11, 12, 14, 25, 26, 2, 29, 21, 23, 27, 28),
    "mmusall_markers" = c(1, 12, 15, 18, 19, 22, 27, 23, 2, 7, 13, 17, 16, 20, 3, 6, 8, 14, 4, 21, 24, 25, 26, 5),
