...
```{r wide1, fig.width = 8, fig.height = 4, include = FALSE, eval = FALSE}
...
```{r long1, fig.width = 6, fig.height = 5, include = FALSE, eval = FALSE}
# only for manually choosing the correction vector
...
if(dataset_curr == "zeb_all_hspc"){
  ...
  correction_vec_list <- list(
    ...
    "random_features" = c(1, 2, 4, 3, c(5:22))
  )
  ...
  correction_vec_list <- list(
    ...
    "random_features" = c(4, 6, 3, 2, 8, 5, 9, 7, 10, 1)
  )   
}
```
