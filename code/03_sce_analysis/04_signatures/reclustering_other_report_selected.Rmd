...
```{r wide1, fig.width = 8, fig.height = 4, inclue = FALSE, eval = FALSE}
...
```{r long1, fig.width = 6, fig.height = 5, , inclue = FALSE, eval = FALSE}
# only for manually choosing the correction vector
...
if(dataset_curr == "zeb_all_hspc"){
  ...
  correction_vec_list <- list(
    ...
    "random_features" = c(2, 3, 1, c(4:22))
  )
  ...
  correction_vec_list <- list(
    ...
    "random_features" = c(2, 1, 5, 6, 3, 4, 7, 8)
  )   
  ...
  correction_vec_list <- list(
    ...
    "random_features" = c(3, 2, 9, 5, 7, 10, 1, 6, 4, 11, 6)
  )   
}
```
