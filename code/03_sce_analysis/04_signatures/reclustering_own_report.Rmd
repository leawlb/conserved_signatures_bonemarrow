...
score_df <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/scRNAseq/main_analysis/sce_objects/03_sce_analysis/04_signatures/03_rclo/score_df_str")
...
plot_sign <- ggplot2::ggplot(sign_df, 
  ...
  ggplot2::ggtitle("conserved signature")
...
plot_mmus <- ggplot2::ggplot(mmus_df, 
  ...
  ggplot2::ggtitle("all BL6 markers")
...
ggplot2::ggplot(
  ...
  ggplot2::scale_color_manual("conservation level", values = c(
    ...
    "ndges" = "orangered1"))+
  ggplot2::ggtitle(base::paste("reclustering", fraction_curr))
```
