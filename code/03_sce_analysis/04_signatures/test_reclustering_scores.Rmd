...
mat_plots <- lapply(df_list_mat, function(df_mat){
  ...
  plot1 <- ggplot2::ggplot(
    ...
    ggplot2::scale_color_manual("score type", col_vec1)+
    ggplot2::ylim(c(0, 1))+
  ...
  plot4 <- ggplot2::ggplot(
    ...
    ggplot2::geom_point(alpha = 0.7)+
    ggplot2::theme_classic()+
    ggplot2::scale_color_manual("score type", col_vec2)+
    ggplot2::geom_hline(yintercept = df_mat$value[df_mat == "total_nr_ct"][1],
                        color = "grey20", 
                        linetype = "dashed")+
    ggplot2::ggtitle(title)+
...
plot2 <- ggplot2::ggplot(
  ...
  ggplot2::geom_line()+
  ggplot2::theme_classic()+
   ggplot2::scale_color_manual("conservation level", col_vec_cons)+
...
sp_plots <- lapply(df_list_sp, function(df_sp){
  ...
  col_vec <- c(
    "median_silhouette_width" = "goldenrod4",
  ...
  plot1 <- ggplot2::ggplot(
    ...
    ggplot2::geom_point(alpha = 0.7)+
    ggplot2::theme_classic()+
    ggplot2::scale_color_manual("score type", values = col_vec)+
    ggplot2::ggtitle(title)+
