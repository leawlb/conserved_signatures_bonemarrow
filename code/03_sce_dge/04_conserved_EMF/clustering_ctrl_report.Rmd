...
#sce <- readRDS("/omics/odcf/analysis/OE0538_projects/DO-0008/data/main_analysis/sce_objects/03_sce_analysis/08_clst/sce_hsc")
...
pheatmap(mat1,
         cluster_rows = FALSE,
         cluster_cols = FALSE,
         main = "non-differentially expressed genes")
...
pheatmap(mat1,
         cluster_rows = FALSE,
         cluster_cols = FALSE,
         main = "genes with conserved marker gene function")
