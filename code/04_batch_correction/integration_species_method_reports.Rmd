...
individual_sce_list <- lapply(individual_sce_list, reduce_dims, nr_hvgs = nr_hvgs) # own function
...
# generic dimensionality reduction
sce_07 <- reduce_dims(sce_07, nr_hvgs = nr_hvgs)
...
# generic dimensionality reduction
sce_08 <- reduce_dims(sce_08, nr_hvgs = nr_hvgs)
...
sce_09mnn <- reduce_dims(sce_09mnn, nr_hvgs = nr_hvgs)
...
qc_plots <- function(sce, title){
  ...
  plot_6 <- umap_base(sce, color_by = "Age")+ 
    scale_color_manual("Age", values = col_ages)+
    ggtitle(paste0(species, title))
  ...
  plot_7 <- umap_base(sce, color_by = "Fraction")+ 
    scale_color_manual("Fraction", values = col_fractions)+
    ggtitle(paste0(species, title))
