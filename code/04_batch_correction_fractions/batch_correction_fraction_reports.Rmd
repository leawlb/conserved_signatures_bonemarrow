...
if(batch_use == "Object_ID"){
  sce_09_mnn <- readRDS(file = snakemake@input[["sce_09_input"]])
  sce_list <- list(list(sce_07, " after merging"),
                   list(sce_08, " after renormalization"),
                   list(sce_09_mnn, " MNN batch correction"))
}else{
  sce_09_mnn <- readRDS(file = snakemake@input[["sce_09_input"]][[1]])
  sce_09_ser <- readRDS(file = snakemake@input[["sce_09_input"]][[2]])
  sce_list <- list(list(sce_07, " after merging"),
                   list(sce_08, " after renormalization"),
                   list(sce_09_mnn, " MNN batch correction"),
                   list(sce_09_ser, " CCA batch correction"))
}
...
sce_09_mnn <- cms(sce_09_mnn, group = "Batch_exp_day", k = 30,
              assay_name = "reconstructed", 
              res_name = "MNN")
visHist(sce_09_mnn, n_col = 3)

if(batch_use != "Object_ID"){
  sce_09_ser <- cms(sce_09_ser, group = "Batch_exp_day", k = 30,
              assay_name = "corrected", 
              res_name = "CCA")
  
  visHist(sce_09_ser, n_col = 3)
...
print(length(which(sce_07$Species_ID == "mmus")))
print(length(which(sce_07$Species_ID == "mcar")))
print(length(which(sce_07$Species_ID == "mcas")))
print(length(which(sce_07$Species_ID == "mspr")))
