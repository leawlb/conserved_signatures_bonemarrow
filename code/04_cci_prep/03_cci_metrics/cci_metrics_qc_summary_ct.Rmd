...
# cell types
ipio_df$emitter <- factor(ipio_df$emitter, levels = names(all_cts)[
  names(all_cts) %in% ipio_df$emitter])
ipio_df$receiver <- factor(ipio_df$receiver, levels = names(all_cts)[
  names(all_cts) %in% ipio_df$receiver])

idio_df$identity <- factor(idio_df$identity, levels = names(all_cts)[
  names(all_cts) %in% idio_df$identity])
nrlrso_df$identity <- factor(nrlrso_df$identity, levels = names(all_cts)[
  names(all_cts) %in% nrlrso_df$identity])

qcdf_gg$Identity <- factor(qcdf_gg$Identity, levels = names(all_cts)[
  names(all_cts) %in% qcdf_gg$Identity])
...
max_qcdf_gg_ds <- max(qcdf_gg_ds$sum) + 150
...
ggplot(idio_df_emi, 
       aes(x = identity, y = nr_cells, color = name))+
  geom_point()+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90))+
  scale_color_discrete("Condition")+
...
ggplot(idio_df_emi, 
       aes(x = identity, y = nr_cells, color = species))+
  geom_point()+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90))+
...
ggplot(idio_df_emi,
       aes(x = identity, y = nr_cells, color = age))+
  geom_point()+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90))+
...
```{r}
ggplot(idio_df_emi, 
       aes(x = identity, y = nr_ints, color = species))+
  geom_point()+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90),
        strip.text.x = element_text(angle = 90))+
  scale_color_manual("Species", values = col_species)+
  ylim(c(0, max(idio_df_emi$nr_ints)))+
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_emi$species))+
  ggtitle("By species")
...
ggplot(idio_df_emi, 
  ...
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_emi$age))+
  ggtitle("By age")
...
ggplot(idio_df_emi, 
  ...
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_emi$name))+
...
ggplot(idio_df_rec, 
  ...
  theme(axis.text.x = element_text(angle = 90),
        strip.text.x = element_text(angle = 90))+
  scale_color_manual("Species", values = col_species)+
  ylim(c(0, max(idio_df_rec$nr_ints)))+
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_rec$species))+
  ggtitle("By species")
...
ggplot(idio_df_rec, 
  ...
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_rec$age))+
  ggtitle("By age")
...
ggplot(idio_df_rec, 
  ...
  xlab("Emitters")+
  ylab("Nr of interactions per cell type")+
  facet_grid(cols = vars(idio_df_rec$name))+
  ggtitle("By condition")
