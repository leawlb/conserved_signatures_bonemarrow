...
identity_plots_09 <- identity_plots(sce_13, title = " ")
...
cluster_plots_13 <- identity_plots(sce_13, title = " ")
...
plot_2 <- pca_base2(sce_13, color_by = "cluster_seurat")+ # own function
  ggtitle(paste0(species_curr, " ", sce_13$seurat_mode[1]))+
  scale_color_manual("cluster (seurat)", values = col_clust_s)
...
plot_3 <- pca_base3(sce_13, color_by = "cluster_seurat")+ # own function
  ggtitle(paste0(species_curr, " ", sce_13$seurat_mode[1]))+
  scale_color_manual("cluster (seurat)", values = col_clust_s)
...
plot2a <- ggplot(ggdf, aes(x = Batch_exp_day, y=cluster_louvain,
  ...
  geom_col()+
  theme_classic()+
  scale_fill_manual("Cluster (louvain)", values = col_clust_l)+
...
plot4 <- ggplot(ggdf, aes(x = Age_ID, y=cluster_louvain,
                          fill=cluster_louvain, color = cluster_louvain))+
  geom_col()+
  theme_classic()+
  scale_fill_manual("Cluster (louvain)", values = col_clust_l)+
