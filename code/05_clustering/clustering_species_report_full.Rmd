...
```{r}
col_cts_all <- col_cts[names(col_cts) %in% sce_12$Identity_ref_all]
col_cts_fraction <- col_cts[names(col_cts) %in% sce_12$Identity_ref_fraction]
...
col_cts_cluster_baccin <- col_cts[names(col_cts) %in% sce_12$cluster_ref_baccin]
col_cts_cluster_dahlin <- col_cts[names(col_cts) %in% sce_12$cluster_ref_dahlin]
col_cts_cluster_dolgalev <- col_cts[names(col_cts) %in% sce_12$cluster_ref_dolgalev]
```
...
identity_plots_09 <- identity_plots(sce_12)
...
plot_1 <- umap_base(sce_12, color_by = "cluster_hierarchical")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$hierarchical_mode[1]))+
  scale_color_manual("cluster (hierarchical)", values = col_clust_h)
plot_1l <- umap_legend(sce_12, color_by = "cluster_hierarchical")+
  scale_color_manual("cluster (hierarchical)", values = col_clust_h)
legend_1 <- get_legend(plot_1l)

plot_2 <- pca_base2(sce_12, color_by = "cluster_hierarchical")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$hierarchical_mode[1]))+
  scale_color_manual("cluster (hierarchical)", values = col_clust_h)
...
plot_3 <- pca_base3(sce_12, color_by = "cluster_hierarchical")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$hierarchical_mode[1]))+
  scale_color_manual("cluster (hierarchical)", values = col_clust_h)
...
ggplot(sil_data, aes(x=cluster, y=width, colour=closest))+
  ...
  theme_classic()+
  ggtitle(paste0(species_curr, " ", sce_12$hierarchical_mode[1]))+
  facet_grid(cols = vars(sce_12$Fraction_ID))+
  scale_color_manual("cluster (hierarchical)", values = col_clust_h)+
  theme(legend.position = "none")+
  xlab("cluster (hierarchical)")+
  ylim(-1, 1)+
...
plot_1 <- umap_base(sce_12, color_by = "cluster_seurat")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$seurat_mode[1]))+
...
plot_1 <- umap_base(sce_12, color_by = "cluster_louvain")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$louvain_mode[1]))+
  scale_color_manual("cluster (louvain)", values = col_clust_l)
plot_1l <- umap_legend(sce_12, color_by = "cluster_louvain")+
  scale_color_manual("cluster (louvain)", values = col_clust_l)
legend_1 <- get_legend(plot_1l)

plot_2 <- pca_base2(sce_12, color_by = "cluster_louvain")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$louvain_mode[1]))+
  scale_color_manual("cluster (louvain)", values = col_clust_l)
...
plot_3 <- pca_base3(sce_12, color_by = "cluster_louvain")+ # own function
  ggtitle(paste0(species_curr, " ", sce_12$louvain_mode[1]))+
  scale_color_manual("cluster (louvain)", values = col_clust_l)
