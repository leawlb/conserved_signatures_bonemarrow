...
cluster_plots <- function(sce){
  ...
  plot_1 <- umap_base(sce, 
    ...
    scale_color_manual("cluster_hierarchical_predicted", values = col_clust_h)
  ...
  plot_2 <- umap_base(sce,
    ...
    ggtitle(paste0(species_curr))+
    scale_color_manual("cluster_seurat_predicted", values = col_clust_s)
  ...
  plot_3 <- umap_base(sce, 
    ...
    ggtitle(paste0(species_curr))+
    scale_color_manual("cluster_louvain_predicted", values = col_clust_l)
