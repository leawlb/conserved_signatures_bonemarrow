...
get_heatmap <- function(data_test, pred_hir){
  ...
  pheatmap(mat_comp,
           main = paste0(data_test$species[1], ", predicted hierarchical clusters (model=mmus)"))
...
get_heatmap <- function(data_test, pred_ser){
  ...
  pheatmap(mat_comp,
           main = paste0(data_test$species[1], ", predicted seurat clusters (model=mmus)"))
...
get_heatmap <- function(data_test, pred_lou){
  ...
  pheatmap(mat_comp,
           main = paste0(data_test$species[1], ", predicted louvain clusters (model=mmus)"))
