...
output_pdf_hsc_umaps <- base::paste0(
   base_path_output_temp,
   "/manuscript1/figures/figure1_b.pdf")
output_pdf_str_umaps <- base::paste0(
   base_path_output_temp,
   "/manuscript1/figures/figure1_c.pdf")
```
...
```{r d_theme_plot_left, fig.height = 8, fig.width = 3}
...
```{r d_theme_plot_right, fig.height = 8, fig.width = 3}
...
```{r d_legend_plot, eval = FALSE, include = FALSE}
...
```{r d_legend_theme_plot, eval = FALSE, include = FALSE}
...
```{r e_prep, eval = FALSE, include = FALSE}
hsc_umap <- base::as.data.frame(
  SingleCellExperiment::reducedDim(
    sce_hsc, type = "UMAP"))
hsc_umap$color_by <- sce_hsc$celltypes
...
```{r e_base_plot_left, eval = FALSE, include = FALSE}
...
```{r e_theme_plot_left, eval = FALSE, include = FALSE}
e_theme_plot_left <- e_base_plot_left+
  cowplot::theme_nothing()
```

```{r e_base_plot_right, eval = FALSE, include = FALSE}
...
```{r e_theme_plot_right, eval = FALSE, include = FALSE}
...
```{r export_bc_plot, eval = FALSE, include = FALSE}
...
pdf(output_pdf_hsc_umaps, width = 3, height = 8)
d_theme_plot_left
dev.off()
```

```{r export_bc_plot_pdf}
pdf(output_pdf_str_umaps, width = 3, height = 8)
d_theme_plot_right
dev.off()
```

```{r bc_assemble_legends, fig.width = 3, fig.height = 5.1, eval = FALSE, include = FALSE}
