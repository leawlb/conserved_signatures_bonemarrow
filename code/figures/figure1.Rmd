...
base_path_output_temp <- "/omics/odcf/analysis/OE0538_projects_temp/DO-0008/data_temp/micromamba_test_rerun/data/"
```
...
colors_path <- base::paste0(
  "/omics/odcf/analysis/OE0538_projects/DO-0008/data/metadata/colors/colors.txt")
