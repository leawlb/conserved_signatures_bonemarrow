...
gene_list_dtplt <- "/omics/odcf/analysis/OE0538_projects_temp/DO-0008/data_temp/metadata_temp/gene_list_dotplot.txt"
...
output_pdf_umap_species_hsc <- base::paste0(
  ...
  "/manuscript1/figures_new/figure1_umap_species_hsc.pdf")
output_pdf_umap_species_str <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_umap_species_str.pdf")
output_pdf_umap_species_legend <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_umap_species_legend.pdf")

output_pdf_umap_spec_sep_hsc <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_umap_specsep_hsc.pdf") 
output_pdf_umap_spec_sep_str <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_umap_specsep_str.pdf") 
output_pdf_umap_spec_sep_legend <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_umap_specsep_legend.pdf") 

output_pdf_dotplot <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_dotplot.pdf") 
output_pdf_dotplot_legend <- base::paste0(
  base_path_output_temp,
  "/manuscript1/figures_new/figure1_dotplot_legend.pdf") 
```
...
```{r e_theme_legend, fig.height = 7, fig.width = 3}
...
```{r bc_construct, fig.width = 13, fig.height = 13, eval = FALSE, include = FALSE}
...
```{r dp_theme_legends, fig.width = 7, fig.height = 1}
...
```{r export_dp_legend}
pdf(output_pdf_dotplot_legend, width = 7, height = 1)
dp_theme_legends
dev.off()
```
