...
plot_HSCs <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         ...
         -Species_ID, -Age_weeks, -Age_ID)
col_HSCs <- grDevices::colorRampPalette(c("grey95", col_cts_hsc["HSCs"], "grey5"))
...
plot_MkEry <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         -pseudotime, -celltypes, -Mouse_ID, 
         -Species_ID, -Age_weeks, -Age_ID)
col_MkEry <- grDevices::colorRampPalette(c("grey95", col_cts_hsc["Mk/Ery progs."], "grey5"))
...
plot_Ery <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         -pseudotime, -celltypes, -Mouse_ID, 
         -Species_ID, -Age_weeks, -Age_ID)
col_Ery <- grDevices::colorRampPalette(c("grey95", col_cts_hsc["Erythroid progs."], "grey5"))
