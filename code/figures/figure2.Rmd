...
output_pdf_pt_umap3_plot <- base::paste0(
  base_path_output_temp, "/manuscript1/figures/figure2_pt_umap3.pdf")
...
output_pdf_pt_umap_legend3 <- base::paste0(
  base_path_output_temp, "/manuscript1/figures/figure2_pt_umap_legend_3.pdf")
...
sce_hsc$pt_ery[sce_hsc$ery < 0.5] <- NA
...
pt_umaps_base_plot_3 <- ggplot2::ggplot(
  ...
  ggplot2::scale_color_gradientn(
    ...
    na.value = "grey90",
    "Pseudotime within\nErythroid branch",
    colours = c(col_cts_hsc["HSCs"], col_cts_hsc["Erythroid progs."]))
...
```{r pt_umaps3_export}
pdf(output_pdf_pt_umap3_plot, width = 2.5, height = 2.5)
pt_umaps_theme_plot_3
dev.off()
```
