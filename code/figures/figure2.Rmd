...
colors_z_score <- c("skyblue2", "white", "red3")
...
marker_1_theme_wide <- marker_1_wide_zs+
  theme_all+
  ggplot2::theme(
    axis.title.y = element_blank(),
    axis.title.x = element_blank(),
...
marker_2_theme_wide <- marker_2_wide_zs+
  theme_all+
  ggplot2::theme(
    axis.title.y = element_blank(),
    axis.title.x = element_blank(),
...
marker_3_theme_wide <- marker_3_wide_zs+
  theme_all+
  ggplot2::theme(
    axis.title.y = element_blank(),
    axis.title.x = element_blank(),
...
rm(
  ...
  pt_umaps_legend1,
  pt_umaps_legend2,
  heatmaps_conds_long_plot,
  heatmaps_conds_stacked_plot,
  heatmaps_conds_wide_plot,
  heatmep_spec_bae_plot,
  heatmap_spec_plot,
  heatmap_spec_theme_plot,
  hsc_umap_comb,
  marker_1_long,
...
col_HSCs <- grDevices::colorRampPalette(c("grey90", 
                                          "grey5"))
palette_HSCs <- col_HSCs(length(geneset_list_hsc[["HSC"]][["conserved_signature"]]))
...
col_MkEry <- grDevices::colorRampPalette(c("grey90", 
                                           "grey5"))
palette_MkEry <- col_MkEry(length(geneset_list_hsc[["Mk/Ery prog"]][["conserved_signature"]]))
...
col_Ery <- grDevices::colorRampPalette(c("grey90", 
                                         "grey5"))
palette_Ery <- col_Ery(length(geneset_list_hsc[["Erythroid"]][["conserved_signature"]]))
```
