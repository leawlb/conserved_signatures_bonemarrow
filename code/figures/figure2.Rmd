...
# don't forget to run "age" part for conserved markers
...
output_pdf_pt_umap3_plot <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_pt_umap3.pdf")

output_pdf_pt_umap_legend3 <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_pt_umap_legend_3.pdf")

output_pdf_sign_heatmap_plot <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_sign_heatmap_plot.pdf")
output_pdf_sign_heatmap_legend <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_sign_heatmap_legend.pdf")

output_pdf_heatmap_spec_plot <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_heatmap_spec_plot.pdf")

output_pdf_heatmap_conds_stacked_plot <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_cond_plot.pdf")

output_pdf_aging_theme_plot <- base::paste0(
  base_path_input, "/manuscript1/figure2/figure2_aging_plot.pdf")
```
...
```{r two_heatmap_assembly, fig.height = 13, fig.width = 6, include = FALSE, eval = FALSE}
...
```{r output_pdf_two_hms, include = FALSE, eval = FALSE}
...
plot_HSCs <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         ...
         -Species_ID, -Age_weeks, -Age_ID)
col_HSCs <- grDevices::colorRampPalette(c("grey90", 
                                          "grey5"))
...
plot_MkEry <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         -pseudotime, -celltypes, -Mouse_ID, 
         -Species_ID, -Age_weeks, -Age_ID)
col_MkEry <- grDevices::colorRampPalette(c("grey90", 
                                           "grey5"))
...
plot_Ery <- plot_data[,c(colnames(plot_data)[1:6],
  ...
  gather(gene, expression,
         -pseudotime, -celltypes, -Mouse_ID, 
         -Species_ID, -Age_weeks, -Age_ID)
col_Ery <- grDevices::colorRampPalette(c("grey90", 
                                         "grey5"))
