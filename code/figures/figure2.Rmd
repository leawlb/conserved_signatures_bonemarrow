...
output_pdf_bcd_plot <- base::paste0(
  base_path, "/manuscript1/figures/figure2_bcd.pdf")
output_pdf_b_legend <- base::paste0(
  base_path, "/manuscript1/figures/figure2_b_legend.pdf")
output_pdf_c_legend <- base::paste0(
  base_path, "/manuscript1/figures/figure2_c_legend.pdf")
output_pdf_ef_plot <- base::paste0(
  base_path, "/manuscript1/figures/figure2_ef.pdf")
```
...
```{r c_plot, fig.width = 3, fig.height = 5}
print(
ggplot(plot_hsc,
...
c_theme_plot <- ggplot2::ggplot(
  ...
  ggplot2::scale_fill_manual(
    values = c("young_in_markers" = "grey40", 
               "n_markers" = col_cons_long[["conserved markers"]], 
               "old_in_markers" = "grey90"))+
...
c_legend_plot <- ggplot2::ggplot(
  ...
  ggplot2::scale_fill_manual(
    labels = c("young", "all conserved markers", "old"),
    values = c("grey40", 
               col_cons_long[["conserved markers"]], 
               "grey90"))
c_legend_plot

c_legend <- ggpubr::get_legend(c_legend_plot)
```

```{r c_theme_legend}
c_theme_legend <- ggpubr::ggarrange(c_legend)
```
...
d_legend <- ggpubr::get_legend(d_theme_plot)
```

#### Construct

```{r e_construct, fig.width = 6, fig.height = 2}
d_plot_theme <- ggpubr::ggarrange(
  d_theme_plot+theme(legend.position = "none")
)
d_plot_theme
```
...
```{r b_c_d_plot, fig.width = 11, fig.height = 12.5}
