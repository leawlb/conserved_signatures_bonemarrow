...
output_pdf_a_legend <- base::paste0(
  base_path, "/manuscript1/figure3/figure3_a_legend.pdf")
...
output_pdf_o1_perm_plot <-  base::paste0(
   base_path, "/manuscript1/figure3/figure3_o1_perm.pdf")
output_pdf_mmms_sign_plot <-  base::paste0(
   base_path, "/manuscript1/figure3/figure3_mmms_sign.pdf")
...
output_pdf_ALL_plot <- base::paste0(
   base_path, "/manuscript1/figure3/figure3_all_dist_plots.pdf")
```
...
```{r big_plot_ALL, fig.width = 12, fig.height = 12}
...
```{r a_plot_export}
pdf(output_pdf_heatmap_own_plot, width = 5, height = 7.8)
a_theme_plot
dev.off()
```
...
```{r a_plot_export}
pdf(output_pdf_heatmaps_others_plot, width = 5, height = 6.5)
d_theme_plot
dev.off()
```
