...
#head(psdf_hsc_mark_rand) # not calculated yet
#head(psdf_hsc_mmms_rand) # not calculated yet
...
# factor for plot
vis_df_mark_own$type_fill <- factor(vis_df_mark_own$type_fill, 
                                    levels = base::rev(c(
  "conserved identity signature",
  "conserved markers",
  "random genes"
)))
vis_df_mark_own$type_y <- factor(vis_df_mark_own$type_y, 
                                 levels = base::rev(c(
  "conserved markers",
  "permutation gene set"
)))
...
vis_df_mmms_own$type_fill <- factor(vis_df_mmms_own$type_fill, 
                                    levels = base::rev(c(
  "conserved identity signature",
  "BL6 markers",
  "random genes"
)))
vis_df_mmms_own$type_y <- factor(vis_df_mmms_own$type_y, 
                                 levels = base::rev(c(
  "BL6 markers",
  "permutation gene set"
)))
...
b_base_plot_bp1 <- ggplot2::ggplot(
  ...
  ggpattern::geom_bar_pattern(
    data = base::data.frame(
      "type_y" = base::rep("permutation gene set", nr_sign_rand_own)),
    inherit.aes = FALSE,
...
b_base_plot_bp2 <- ggplot2::ggplot(
  ...
  ggpattern::geom_bar_pattern(
    data = base::data.frame(
      "type_y" = base::rep("permutation gene set", nr_mark_rand_own)),
    inherit.aes = FALSE,
    mapping = aes(y = type_y),
    position = position_dodge(preserve = "single"),
    pattern = "stripe",
...
b_base_plot_bp3 <- ggplot2::ggplot(
  ...
  ggpattern::geom_bar_pattern(
    data = base::data.frame(
      "type_y" = base::rep("permutation gene set", nr_mmms_rand_own)),
    inherit.aes = FALSE,
    mapping = aes(y = type_y),
    position = position_dodge(preserve = "single"),
    pattern = "stripe",
