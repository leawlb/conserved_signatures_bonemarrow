...
b_theme_plot_left1 <- b_base_plot_left1+
  ...
  ggplot2::ggtitle(score1_long) #TODO: continue here
```
...
```{r e_base_plot_left2}
e_base_plot_left2 <- ggplot2::ggplot(
  score_df_mark_score_1_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mark_signrand_score_1_o1,
    color = col_cons_long["conserved markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r e_base_plot_left3}
e_base_plot_left3 <- ggplot2::ggplot(
  score_df_mmms_score_1_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mmms_signrand_score_1_o1,
    color = col_cons_long["total BL6 markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
e_base_plot_mleft2 <- ggplot2::ggplot(
  score_df_mark_score_2_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mark_signrand_score_2_o1,
    color = col_cons_long["conserved markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
e_base_plot_mleft3 <- ggplot2::ggplot(
  score_df_mmms_score_2_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mmms_signrand_score_2_o1,
    color = col_cons_long["total BL6 markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
e_base_plot_mright2 <- ggplot2::ggplot(
  score_df_mark_score_3_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mark_signrand_score_3_o1,
    color = col_cons_long["conserved markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
e_base_plot_mright3 <- ggplot2::ggplot(
  score_df_mmms_score_3_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
      color = conservation_level_long))+
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.25, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_mmms_signrand_score_3_o1,
    color = col_cons_long["total BL6 markers"],
    alpha = 1,
    side = "r",
    scale = "width",
...
e_part_right <- ggpubr::ggarrange(
  ncol = 1, 
  e_theme_plot_right1, # barplot width depends on plot size
  e_theme_plot_right2,
  e_theme_plot_right3,
  heights = c(1.05, 1, 1),
  align = "v"
...
```{r e_construct_all, fig.height = 3.5, fig.width = 13}
...
```{r e_plot_export}
pdf(output_pdf_e_plot, width = 12.7, height = 3.7)
e_all_plot
dev.off()
```
...
psdf_hsc_sign_rand_long_o1 <- tidyr::pivot_longer(
  psdf_hsc_sign_rand_o1, 
  c = 1:(ncol(psdf_hsc_sign_rand_o1)-1),
  values_to = "value",
  names_to = "type")

psdf_hsc_sign_rand_long_o1$conservation_level_long = base::rep(
  "conserved identity signature", nrow(psdf_hsc_sign_rand_long_o1))

psdf_sign_rand_score_1_o1 <- psdf_hsc_sign_rand_long_o1[
  psdf_hsc_sign_rand_long_o1$type %in% c("adjusted_rand_index"),]
psdf_sign_rand_score_2_o1 <- psdf_hsc_sign_rand_long_o1[
  psdf_hsc_sign_rand_long_o1$type %in% c("variation_information"),]
psdf_sign_rand_score_3_o1 <- psdf_hsc_sign_rand_long_o1[
  psdf_hsc_sign_rand_long_o1$type %in% c("mean_prop_cells_cluster"),]
```

Make DF with gene numbers also for conserved signature background permutation.

```{r f_prep2}
f_vis_df_sign_rand <- base::data.frame(
  type_y = c(
    "conserved identity signature",
    "permutation gene set"),
  type_fill = c(
...
f_vis_df_sign_rand$type_fill <- factor(
  f_vis_df_sign_rand$type_fill,
  levels = base::rev(c(
    "conserved identity signature",
    "random genes")))

f_vis_df_sign_rand$type_y <- factor(
  f_vis_df_sign_rand$type_y, 
  levels = base::rev(c(
    "conserved identity signature",
    "permutation gene set")))
```
...
```{r f_base_plot_left}
f_base_plot_left <- ggplot2::ggplot(
  score_df_sign_score_1_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_1_o1,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r f_theme_plot_left}
f_theme_plot_left <- f_base_plot_left+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r f_base_plot_mleft}
f_base_plot_mleft <- ggplot2::ggplot(
  score_df_sign_score_2_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_2_o1,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r f_theme_plot_mleft}
f_theme_plot_mleft <- f_base_plot_mleft+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r f_base_plot_mright}
f_base_plot_mright <- ggplot2::ggplot(
  score_df_sign_score_3_o1,
  aes(x = conservation_level_long,
      y = value,
      fill = conservation_level_long,
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_3_o1,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r f_theme_plot_mright}
f_theme_plot_mright <- f_base_plot_mright+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r f_base_plot_right}
f_base_plot_right <- ggplot2::ggplot(
  f_vis_df_sign_rand,
  aes(y = type_y, 
        x = number, 
      fill = type_fill))+
...
```{r c_theme_plot_right}
f_theme_plot_right <- f_base_plot_right+
  ggplot2::theme_classic()+
  ggplot2::theme(
    axis.title.y = element_blank(),
    axis.text.y = element_blank(),
...
```{r r_assemble_plot, fig.width = 12.7, fig.height = 1.8}
...
```{r f_plot_export}
pdf(output_pdf_f_plot, width = 12.7, height = 1.8)
f_theme_plot
dev.off()
```
...
score_df_hsc_o2 <- bind_rows(selected_score_df_list_o2)
```
...
psdf_hsc_sign_rand_long_o2 <- tidyr::pivot_longer(
  psdf_hsc_sign_rand_o2, 
  c = 1:(ncol(psdf_hsc_sign_rand_o2)-1),
  values_to = "value",
  names_to = "type")

psdf_hsc_sign_rand_long_o2$conservation_level_long = base::rep(
  "conserved identity signature", nrow(psdf_hsc_sign_rand_long_o2))

psdf_sign_rand_score_1_o2 <- psdf_hsc_sign_rand_long_o2[
  psdf_hsc_sign_rand_long_o2$type %in% c("adjusted_rand_index"),]
psdf_sign_rand_score_2_o2 <- psdf_hsc_sign_rand_long_o2[
  psdf_hsc_sign_rand_long_o2$type %in% c("variation_information"),]
psdf_sign_rand_score_3_o2 <- psdf_hsc_sign_rand_long_o2[
  psdf_hsc_sign_rand_long_o2$type %in% c("mean_prop_cells_cluster"),]
```
...
```{r f_prep2}
g_vis_df_sign_rand <- base::data.frame(
  type_y = c(
    "conserved identity signature",
    "permutation gene set"),
  type_fill = c(
...
g_vis_df_sign_rand$type_fill <- factor(
  f_vis_df_sign_rand$type_fill,
  levels = base::rev(c(
    "conserved identity signature",
    "random genes")))

g_vis_df_sign_rand$type_y <- factor(
  g_vis_df_sign_rand$type_y, 
  levels = base::rev(c(
    "conserved identity signature",
    "permutation gene set")))
```
...
```{r g_base_plot_left}
g_base_plot_left <- ggplot2::ggplot(
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_1_o2,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r g_theme_plot_left}
g_theme_plot_left <- g_base_plot_left+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r g_base_plot_mleft}
g_base_plot_mleft <- ggplot2::ggplot(
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_2_o2,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r g_theme_plot_mleft}
g_theme_plot_mleft <- g_base_plot_mleft+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r g_base_plot_mright}
g_base_plot_mright <- ggplot2::ggplot(
  ...
  ggplot2::geom_point(
    ...
    position = position_nudge(x = 0.5, y = 0))+
  gghalves::geom_half_violin(
    data = psdf_sign_rand_score_3_o2,
    color = col_cons_long["conserved identity signature"],
    alpha = 1,
    side = "r",
    scale = "width",
...
```{r g_theme_plot_mright}
g_theme_plot_mright <- g_base_plot_mright+
  ggplot2::theme_classic()+
  ggplot2::scale_color_manual(
    "Score",
    values = col_cons_long)+
...
```{r g_base_plot_right}
g_base_plot_right <- ggplot2::ggplot(
  g_vis_df_sign_rand,
  aes(y = type_y, 
        x = number, 
      fill = type_fill))+
...
```{r g_theme_plot_right}
g_theme_plot_right <- g_base_plot_right+
  ggplot2::theme_classic()+
  ggplot2::theme(
    axis.title.y = element_blank(),
    axis.text.y = element_blank(),
...
```{r g_assemble_plot, fig.width = 12.7, fig.height = 1.8}
...
```{r g_plot_export}
pdf(output_pdf_g_plot, width = 12.7, height = 1.8)
g_theme_plot
dev.off()
```
