...
output_pdf_heatmap_own_plot <- base::paste0(
   base_path_output_temp, "/manuscript1/figures/figure3_heatmap_own.pdf")
output_pdf_heatmaps_others_plot <- base::paste0(
   base_path_output_temp, "/manuscript1/figures/figure3_heatmaps_others.pdf")
output_pdf_ALL_plot <- base::paste0(
   base_path_output_temp, "/manuscript1/figures/figure3_all_dist_plots.pdf")
...
# 
# output_bigplot_own_poster <- base::paste0(
#    base_path_output_temp, "/manuscript1/figures/figure3_bigplot_own_poster.pdf")
# output_pdf_a_plot_poster <- base::paste0(
#    base_path_output_temp, "/manuscript1/figures/figure3_a_poster.pdf")
# output_pdf_bp_legend_poster <- base::paste0(
#    base_path_output_temp, "/manuscript1/figures/figure3_pb_legend_poster.pdf")
```
...
library(scater)
plotReducedDim(sce_hsc_recl, "UMAP", colour_by = "Cd79b")
```
...
```{r bigplot_assemble_o1, fig.width = 12, fig.height = 10}
...
```{r big_plot_signrand, fig.width = 12, fig.height = 3}
...
sign_df$Var2 <- factor(
  sign_df$Var2,
  levels = base::rev(c(1, 3, 2, 6, 8, 9, 4, 5, 7)))
```
...
mark_df$Var2 <- factor(
  mark_df$Var2,
  levels = base::rev(c(1, 3, 9, 5, 2, 6, 4, 7, 10, 8)))
```
...
```{r a_assemble, fig.height = 7, fig.width = 4}
...
```{r a_plot_export}
pdf(output_pdf_heatmap_own_plot, width = 4, height = 7)
a_theme_plot
dev.off()
```
...
selected_seu_list_o1$seu_mmms$cell_type[
  selected_seu_list_o1$seu_mmms$cell_type == "Slamf1-positive multipotent progenitor cell"] <- "Slamf1+ p."
selected_seu_list_o1$seu_mmms$cell_type[
  selected_seu_list_o1$seu_mmms$cell_type == "Slamf1-negative multipotent progenitor cell"] <- "Slamf1- p."
selected_seu_list_o1$seu_mmms$cell_type[
  selected_seu_list_o1$seu_mmms$cell_type == "granulocyte monocyte progenitor cell"] <- "granu-mono p."
selected_seu_list_o1$seu_mmms$cell_type[
...
selected_seu_list_o1$seu_mmms$cell_type[
  selected_seu_list_o1$seu_mmms$cell_type == "common lymphoid progenitor"] <- "common lymphoid p."
selected_seu_list_o1$seu_mmms$cell_type[
  selected_seu_list_o1$seu_mmms$cell_type ==  "megakaryocyte-erythroid progenitor cell"] <-  "mk-ery p."
...
selected_seu_list_o1$seu_sign$cell_type[
  selected_seu_list_o1$seu_sign$cell_type == "Slamf1-positive multipotent progenitor cell"] <- "Slamf1+ p."
selected_seu_list_o1$seu_sign$cell_type[
  selected_seu_list_o1$seu_sign$cell_type == "Slamf1-negative multipotent progenitor cell"] <- "Slamf1- p."
selected_seu_list_o1$seu_sign$cell_type[
  selected_seu_list_o1$seu_sign$cell_type == "granulocyte monocyte progenitor cell"] <- "granu-mono p."
selected_seu_list_o1$seu_sign$cell_type[
...
selected_seu_list_o1$seu_sign$cell_type[
  selected_seu_list_o1$seu_sign$cell_type == "common lymphoid progenitor"] <- "common lymphoid p."
selected_seu_list_o1$seu_sign$cell_type[
  selected_seu_list_o1$seu_sign$cell_type ==  "megakaryocyte-erythroid progenitor cell"] <-  "mk-ery p."
...
```{r d_construct, fig.width = 4, fig.height = 6}
...
```{r a_plot_export}
pdf(output_pdf_heatmaps_others_plot, width = 4, height = 6)
d_theme_plot
dev.off()
```
