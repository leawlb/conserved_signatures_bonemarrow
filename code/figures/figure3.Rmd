...
TODO: mmms_vs_signrand is mssing here
...
```{r assemble_bigplot_own_poster, fig.width = 12, fig.height = 10}
...
pdf(output_bigplot_own_poster, width = 9, height = 3.5)
b_plot_poster
dev.off()
```
...
```{r theme_plot_bp1_o1_signrand, fig.width = 4, fig.height = 2}
...
```{r theme_plot_bp1_o1_signrand, fig.width = 4, fig.height = 3}
legend_bp_all_poster_theme <- ggpubr::get_legend(base_plot_bp1_o1_signrand+theme_all)
legend_bp_all_poster <- ggpubr::ggarrange(legend_bp_all_poster_theme)
```
...
```{r a_assemble, fig.height = 7, fig.width = 3}
...
```{r de_construct2, fig.width = 4, fig.height = 7}
...
```{r pval_base_plot_owm, fig.width = 10, fig.height= 3} 
...
```{r pval_theme_plot_own, fig.width = 9, fig.height = 2} 
...
```{r pval_base_plot_others, fig.width = 10, fig.height= 3} 
...
```{r pval_theme_plot_others, fig.width = 10, fig.height = 2} 
...
```{r pval_base_plot_others2, fig.width = 10, fig.height= 3} 
...
```{r pval_theme_plot_others2, fig.width = 8, fig.height = 2} 
...
```{r pval_legend_theme_plot, fig.width = 4, fig.height= 4}
