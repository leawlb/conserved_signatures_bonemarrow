...
## Plots: Comparing OTHER 3 scores to random background
...
```{r big_plot_o2, fig.width = 12, fig.height = 3}
...
```{r big_plot_o1o2, fig.width = 12, fig.height = 5}
big_plot_o2 <- ggpubr::ggarrange(
  ncol = 4,
  align = "hv",
  plot_bp_o2,
...
```{r big_plot_o1o2_ow, fig.width = 12, fig.height = 5}
...
plot_bp_all <- ggpubr::ggarrange(
  ncol = 1,
  heights = c(other_than_1, 1, 1, other_than_1, 1, 1, 1, other_than_1, 1),
  align = "v",
  theme_plot_bp1_own,
  theme_plot_bp2_own,
  theme_plot_bp3_own,  
...
```{r big_plot_ALL, fig.width = 12, fig.height = 13}
...
pdf(output_pdf_ALL_plot, width = 12, height = 13)
big_plot_ALL
dev.off()
```
...
```{r de_construct2, fig.width = 4, fig.height = 8}
