...
seu_sign_o1$annotated_reclustered[seu_sign_o1$seurat_clusters == nr] <- "HSC"
```
...
seu_sign_o1$annotated_reclustered[seu_sign_o1$seurat_clusters == nr] <- "Late Ery"
```
...
seu_sign_o1$annotated_reclustered[seu_sign_o1$seurat_clusters == nr] <- "Ery"
```
...
seu_sign_o1$annotated_reclustered[seu_sign_o1$seurat_clusters == nr] <- "Early Myeloid"
```
...
seu_sign_o1$annotated_reclustered[seu_sign_o1$seurat_clusters == nr] <- "Neutro"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "HSC batch 3'V2"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "HSC batch 5'V3"
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "HSC mixed"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "Mono (Dendritic)"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "Mono (Cycling)"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "Mk/Ery batch 3'V2"
```
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "Mk/Ery batch 5'V3"
stop()
```
...
seu_sign_o2$cell_type[seu_sign_o2$cell_type == "common myeloid progenitor"] <- "common myeloid prog"
seu_sign_o2$cell_type[seu_sign_o2$cell_type == "granulocyte monocyte progenitor cell"] <- "granu-mono prog"
seu_sign_o2$cell_type[seu_sign_o2$cell_type == "early lymphoid progenitor"] <- "early lymphoid prog"
seu_sign_o2$cell_type[seu_sign_o2$cell_type == "megakaryocyte-erythroid progenitor cell"] <- "mk-ery prog"
...
sign_df_o1_anno$Var1[sign_df_o1_anno$Var1 == "common myeloid progenitor"] <- "common myeloid prog"
sign_df_o1_anno$Var1[sign_df_o1_anno$Var1 == "erythroid progenitor cell"] <- "erythroid prog"
...
sign_df_o2$Var1[sign_df_o2$Var1 == "common myeloid progenitor"] <- "common myeloid prog"
sign_df_o2$Var1[sign_df_o2$Var1 == "granulocyte monocyte progenitor cell"] <- "granu-mono prog"
sign_df_o2$Var1[sign_df_o2$Var1 == "early lymphoid progenitor"] <- "early lymphoid prog"
sign_df_o2$Var1[sign_df_o2$Var1 == "megakaryocyte-erythroid progenitor cell"] <- "mk-ery prog"
