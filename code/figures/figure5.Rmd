...
Also contains supplementary figure parts XYZ. 
...
for(ct in names(geneset_list_str)){
  BL6_genes <- unique(
    c(BL6_genes,
      geneset_list_str[[ct]]$conserved_df$gene[!is.na(geneset_list_str[[ct]]$conserved_df$mmus)]))
  signature_genes <- unique(c(signature_genes, geneset_list_str[[ct]]$conserved_signature))
}
...
# FBN1: related to TGFβ, MSC diff, MSC niche/decisions, MSC activitiy
