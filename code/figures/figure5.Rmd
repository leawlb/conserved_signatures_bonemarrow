...
ct_markers_o2_ec[[nr]][
    ...
    ct_markers_o2_ec[[nr]]$genes %in% ensembl_sign$MMUS_SYMBOL,][1:50,]
...
# Dll4: arterial diff, restricts vessel branching, sprouting angiogenesis and artery formation, capillary endothelial tip cells, capillarization of liver sinusoids 
...
seu_sign_o2$annotated_reclustered[seu_sign_o2$seurat_clusters == nr] <- "Ven EC2, pbs"
```
