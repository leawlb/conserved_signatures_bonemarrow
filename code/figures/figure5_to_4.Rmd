...
#   base_path_output_temp, "/manuscript1/figures/figure5_abc.pdf")
# output_pdf_d_plot <- base::paste0(
#   base_path_output_temp, "/manuscript1/figures/figure5_d.pdf")
# output_pdf_d_legend <- base::paste0(
#   base_path_output_temp, "/manuscript1/figures/figure5_d_legend.pdf")
...
```{r mat_mark_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r mat_mmms_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r sign_base_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r sign_theme_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r mark_base_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r mark_theme_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r mmms_base_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r mmms_theme_plot_o3, include = FALSE, eval = FALSE}
#zebrafish
...
```{r c_plotparts, fig.height = 10, fig.width = 3, include = FALSE, eval = FALSE}
...
```{r abc_assemble, fig.height = 10, fig.width = 9, include = FALSE, eval = FALSE}
