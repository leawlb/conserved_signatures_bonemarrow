...
factorize <- list(human = rev(c(7,8,9,13,11,12,3,0,4,14,6,2,10,1,5)),
                  marmoset = rev(c(0,2,14,4,1,7,10,13,8,12,5,9,3,11,6)),
                  macaque = rev(c(0,1,6,8,9,2,11,3,5,4,7,10)))
```
...
factorize_mouse <- list(hs = c(0, 10, 4, 6, 7, 3, 5, 8, 9, 1, 11, 2),
                        sig = c(4, 9, 3, 1, 8, 6, 5, 7, 10, 0, 2))
```
