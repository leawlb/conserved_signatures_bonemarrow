...
Generate Figure 2: HSPC signature genes.
...
output_pdf_pt_umap3_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_pt_umap3.pdf")

output_pdf_pt_umap_legend3 <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_pt_umap_legend_3.pdf")

output_pdf_sign_heatmap_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_sign_heatmap_plot.pdf")
output_pdf_sign_heatmap_legend <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_sign_heatmap_legend.pdf")

output_pdf_heatmap_spec_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_heatmap_spec_plot.pdf")

output_pdf_pt_scaled <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_pt_scaled_plot.pdf")
output_pdf_heatmap_conds_stacked_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_cond_plot.pdf")
output_pdf_heatmap_conds_stacked_legend <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_cond_legend.pdf")

output_pdf_aging_theme_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_aging_plot.pdf")
output_pdf_aging_theme_legend <- base::paste0(
  base_path, "/manuscript1_rev/figure2/figure2_aging_legend.pdf")
```
...
conserved_markers_list <- lapply(geneset_list_hsc, function(geneset){
...
mmus_marker_list <- lapply(geneset_list_hsc, function(geneset){
...
# factorize
agg_hsc_df$gene <- factor(
  agg_hsc_df$gene,
  levels = all_sign_genes_for_factor)
agg_hsc_df$species <- factor(
  agg_hsc_df$species,
  levels = base::rev(names(col_spc_pub)))
```

```{r sign_heatmap6}
interest_genes <- c("Lmo2",
                    "Txnip",
                    "Pnrc1",
                    "Msi2",
                    "Mecom",
...
```{r print_plot, fig.width = 30, fig.height = 5, include = FALSE, eval = FALSE}
sign_heatmap_base_plot+ # print to confirm the order of genes depicted
  ggplot2::theme(axis.text.x = element_text(
    angle = 90, size = 14, hjust = 1, vjust = 0.5))
```
...
# print genes that are BL6-specific in HSCs
...
# do the same but for other cell types and BL6-specificity, only
...
# ery branch
ery_cut_off <- base::min(ery_pseudo$Erythroid)
