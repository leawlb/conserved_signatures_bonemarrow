...
output_pdf_heatmap_own_plot <- base::paste0(
   base_path, "/manuscript1_rev/figure4/figure4_heatmap_own.pdf")
output_pdf_heatmap_own_legend <- base::paste0(
  base_path, "/manuscript1_rev/figure4/figure4_heatmap_legend.pdf")

output_pdf_own_perm_plot <-  base::paste0(
   base_path, "/manuscript1_rev/figure4/figure4_own_perm.pdf")
output_pdf_o1_perm_plot <-  base::paste0(
   base_path, "/manuscript1_rev/figure4/figure4_other_perm.pdf")
output_pdf_mmms_sign_plot <-  base::paste0(
   base_path, "/manuscript1_rev/figure4/figure4_mmms_signrand_perm.pdf")

output_pdf_heatmaps_others_plot <- base::paste0(
   base_path, "/manuscript1_rev/figure4/figure4_heatmaps_others.pdf")
