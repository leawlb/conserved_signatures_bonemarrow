...
Heatmaps of own or published niche data using signature genes.

For other datasets, this includes blind re-annotation following
custom, manual clustering.

mus_tik_str has been blindly annotated in 03_sce_analysis/04_signatures/04_blind_annotation.
li_all_str has been blindly annotated in 03_sce_analysis/04_signatures/04_blind_annotation 
as well. 
