...
output_pdf_e_plot <- base::paste0(
  base_path, "/manuscript1_rev/figure5/figure5_e.pdf")
output_pdf_e_legend <- base::paste0(
  base_path, "/manuscript1_rev/figure5/figure5_e_legend.pdf")

export_signature_table_path <- base::paste0(
   base_path, "/manuscript1_rev/str_signature_table.csv")
```
