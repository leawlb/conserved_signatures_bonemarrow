...
Figure_S4: nr of genes vs nr of cells, condition plot, pseudotime UMAPs 
Figure_S4_silhouette: silhouette score calculation
Figure_S4_genes_v_pseudotime: genes along pseudotime trajectory 
Figure_S4_genes: aging genes
...
output_pdf_b <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/plot_b.pdf")

output_pdf_umap_neu <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/umap_n.pdf")

output_pdf_umap_lym <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/umap_l.pdf")

output_pdf_umap_legend <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/umap_legend.pdf")

output_pdf_condplot <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/cond_plot.pdf")
  
output_pdf_condlegend <- base::paste0(
  base_path,
  "/manuscript1_rev/figures4/cond_legend.pdf")
```
...
b_theme_plot <- b_base_plot+
  ggplot2::ylab("# signature genes per cell type")+
  ggplot2::xlab("# cells per cell type")+
  ggplot2::scale_y_continuous(limits = c(0, 230), breaks = c(0, 100, 200))+
  ggplot2::scale_x_continuous(limits = c(0, 12000), breaks = c(0, 5000, 10000))+
  theme_all_supp+
  ggplot2::theme(
...
marker_1_wide <- ggplot(plot_1,
       aes(x = factor(celltypes, levels = names(geneset_list_hsc)),
           ...
           color = signature,
           size = signature)) +
  ggplot2::geom_tile(width = 0.95, 
            height = 0.95) +
  theme_classic() +
  ggplot2::theme(axis.text.x = element_text(angle = 90, h = 1)) +
  ggplot2::scale_color_manual(guide = "none", values = c(alpha("black", 0), "grey50")) +
  ggplot2::scale_size_manual(guide = "none", values = c(0, 0.4)) +
  ggplot2::labs(x = NULL, y = NULL, title = g[1]) +
...
marker_2_wide <- ggplot(plot_2,
  ...
  ggplot2::scale_color_manual(guide = "none", values = c(alpha("black", 0), "grey50")) +
  ggplot2::scale_size_manual(guide = "none", values = c(0, 0.4)) +
  ggplot2::labs(x = NULL, y = NULL, title = g[2]) +
  ggplot2::scale_fill_gradientn(
    "z-score per gene", 
    colours = colors_z_score,
    breaks = c(-8, -4, 0, 4, 8),
...
marker_3_wide <- ggplot(plot_3,
  ...
  ggplot2::scale_color_manual(guide = "none", values = c(alpha("black", 0), "grey50")) +
  ggplot2::scale_size_manual(guide = "none", values = c(0, 0.4)) +
  ggplot2::labs(x = NULL, y = NULL, title = g[3]) +
  ggplot2::scale_fill_gradientn(
    "z-score per gene", 
    colours = colors_z_score,
    breaks = c(-8, -4, 0, 4, 8),
...
marker_4_wide <- ggplot(plot_4,
  ...
  ggplot2::scale_color_manual(guide = "none", values = c(alpha("black", 0), "grey50")) +
  ggplot2::scale_size_manual(guide = "none", values = c(0, 0.4)) +
  ggplot2::labs(x = NULL, y = NULL, title = g[4]) +
  ggplot2::scale_fill_gradientn(
    "z-score per gene", 
    colours = colors_z_score,
    breaks = c(-8, -4, 0, 4, 8),
