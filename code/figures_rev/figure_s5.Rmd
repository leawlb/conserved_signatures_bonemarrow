...
Supplementary figure extended HSPC reclustering (mouse mostly).
Related to Figure 3. 

Assignments to panels a, b, c, etc. are probably deprecated. 

The signature reclaim plot is generating in another file, reclaim_sigs.Rmd
...
For the optimization plots, as examples two optimizations from mouse
HSPC datasets are shown.
...
output_pdf_a_plot <- base::paste0(
  base_path,
  "/manuscript1_rev/figures5/a_scores_plot.pdf")

output_pdf_a_legend <- base::paste0(
  base_path,
  "/manuscript1_rev/figures5/a_scores_plot_legend.pdf")

output_pdf_b_pval <- base::paste0(
  base_path,
  "/manuscript1_rev/figures5/b_pval_plot.pdf")

output_pdf_c_heatmaps <- base::paste0(
  base_path,
  "/manuscript1_rev/figures5/c_heatmaps.pdf")

output_pdf_c_heatmaps_legend <- base::paste0(
  base_path,
  "/manuscript1_rev/figures5/c_heatmaps_legend.pdf")
```
...
The order may change, but export all of them at once.
